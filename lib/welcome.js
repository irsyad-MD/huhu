...
const { flamming: flamming, dynamic: dynamic, estetik: estetik } = JSON.parse(readFileSync("./LeoMedia/image.json"));
...
module.exports =  { ImageEditor, Welcome, Leave, OTP, BannerBot };